...
STORM_JAR = "{}/benchmarks/storm-bench/target/storm-bench-{}.jar".format(CWD, NAMB_VERSION)
STORM_CLASS = "fr.unice.namb.storm.BenchmarkApplication"

HERON_CONF = "{}/heron-benchmark.yml".format(CONF_PATH)
HERON_JAR = "{}/benchmarks/heron-bench/target/heron-bench-{}.jar".format(CWD, NAMB_VERSION)
HERON_CLASS = "fr.unice.namb.heron.BenchmarkApplication"

FLINK_CONF = "{}/flink-benchmark.yml".format(CONF_PATH)
FLINK_JAR = "{}/benchmarks/flink-bench/target/flink-bench-{}.jar".format(CWD, NAMB_VERSION)
